...
const upload = multer({ dest: '../../Tenarse/Server/uploads/user_img' });
...
app.use((req, res, next) => {
    res.setHeader('Access-Control-Allow-Origin', 'https://tenarse.online');
    next();
  });
...
// Ruta de la carpeta
app.use('/Tenarse/Server/uploads/user_img', express.static('../../Tenarse/Server/uploads/user_img'));
app.use('/Tenarse.apk', express.static('../../Tenarse.apk'));

app.use('/Tenarse/Server/uploads/images', express.static('../../Tenarse/Server/uploads/images'));
app.use('/Tenarse/Server/uploads/videos', express.static('../../Tenarse/Server/uploads/videos'));
...
app.use(function (req, res, next) {
    res.header("Access-Control-Allow-Origin", "https://tenarse.online");
...
app.post('/getMyProfil2', function (req, res) {
    console.log("SHHHHHHHHHHHHHHHHHH", req.session)
    readDB.getUserByEmail(req.session.email, function (status) {
        console.log(req.session.email);
        console.log(status)
        if (status != null) { 
...
app.post('/verifyCode', (req, res ) =>{
    ...
    const usuari = {
        ...
        username: username,
        password: CryptoJS.SHA256(pass).toString(),
        url_img: 'https://tenarse.online/Tenarse/Server/uploads/user_img/default_user_img.png',
        socket: ' ',
        nombre: name,
        apellidos: surname,
        fecha_nac: '28/08/2003'
...
app.post('/upload', upload.single('image'), (req, res) => {
    ...
    .then((id) => {
      ...
      fs.readFile(filePath, (err, data) => {
        ...
        const newPath = `/var/www/html/Tenarse/Server/uploads/user_img/${newFileName}`;
        console.log(newPath);
